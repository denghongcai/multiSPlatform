...
WSDL.prototype.objectToRpcXML = function(name, params, namespace, xmlns) {
    var self = this,
        ...
        nsAttrName = '_xmlns';
    namespace = 'ns1';
    parts.push(['<',namespace,':',name,' soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"',
    ' xmlns:ns1="http://218.106.126.38:8000/sxt/services/SxtServiceFacede"','>'].join(''));
    parts.push('<ns1:arg0 xsi:type="soapenc:string" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/">');
    for (var key in params) {
        if (key != nsAttrName) {
            var value = params[key];
            parts.push(['&lt;',key,'&gt;'].join(''));
            parts.push(this.objectToXML(value));
            parts.push(['&lt;/',key,'&gt;'].join(''));
        }
    }
    parts.push('</ns1:arg0>');
